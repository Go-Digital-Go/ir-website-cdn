/*! UIkit 2.26.4 | http://www.getuikit.com | (c) 2014 YOOtheme | MIT License */ ! function(i) {
    var t;
    ...
    i.$.extend(i.slideshow.animations, {
        slice: function(e, s, n, o) {
            ...
            for (var r, a = i.$.Deferred(), c = Math.ceil(this.element.width() / this.options.slices), d = s.data("cover").css("background-image"), h = i.$("<li></li>").css({
                    top: 0,
                    left: 0,
                    ...
                    opacity: 1,
                    zIndex: 15
                }), p = h.width(), l = h.height(), u = "slice-up" == o ? l : "0", f = 0; f < this.options.slices; f++) {
                ...
                }).data("clip", v), h.append(r)
            }
            return this.container.append(h), h.children().last().on(i.support.transition.end, function() {
                setTimeout(h.remove.bind(h), 0), a.resolve()
            }), h.width(), h.children().each(function() {
                var t = i.$(this);
                t.css({
                    clip: t.data("clip"),
                    opacity: 1
        ...
        fold: function(e, s) {
            ...
            for (var n, o = i.$.Deferred(), r = Math.ceil(this.element.width() / this.options.slices), a = s.data("cover").css("background-image"), c = i.$("<li></li>").css({
                    ...
                    opacity: 1,
                    zIndex: 15
                }), d = s.width(), h = s.height(), p = 0; p < this.options.slices; p++) n = i.$('<div class="uk-cover-background"></div>').css({
                position: "absolute",
                top: 0,
                left: 0,
                width: d,
                ...
                clip: "rect(0px, " + r * (p + 1) + "px, " + h + "px, " + r * p + "px)",
                opacity: 0,
            ...
            return this.container.append(c), c.width(), c.children().first().on(i.support.transition.end, function() {
                setTimeout(c.remove.bind(c), 0), o.resolve()
            }).end().css({
                transform: "scaleX(1)",
                opacity: 1
            }), o.promise()
        ...
        puzzle: function(s, n) {
            ...
            for (var o, r, a, c = i.$.Deferred(), d = this, h = Math.round(this.options.slices / 2), p = Math.round(n.width() / h), l = Math.round(n.height() / p), u = Math.round(n.height() / l) + 1, f = n.data("cover").css("background-image"), m = i.$("<li></li>").css({
                    width: this.container.width(),
                    height: this.container.height(),
                    opacity: 1,
                    zIndex: 15
                }), x = this.container.width(), v = this.container.height(), g = 0; l > g; g++)
                for (var w = 0; h > w; w++) a = w == h - 1 ? p + 2 : p, r = [u * g + "px", a * (w + 1) + "px", u * (g + 1) + "px", p * w + "px"], o = i.$('<div class="uk-cover-background"></div>').css({
                    position: "absolute",
                    top: 0,
                    left: 0,
                    opacity: 0,
            ...
            return b.each(function(t) {
                ...
                setTimeout(m.remove.bind(m), 0), c.resolve()
            }), m.width(), b.css({
                opacity: 1
            }), c.promise()
        },
        boxes: function(e, s, n, o) {
            if (!s.data("cover")) return t.fade.apply(this, arguments);
            for (var r, a, c, d, h = i.$.Deferred(), p = Math.round(this.options.slices / 2), l = Math.round(s.width() / p), u = Math.round(s.height() / l), f = Math.round(s.height() / u) + 1, m = s.data("cover").css("background-image"), x = i.$("<li></li>").css({
                    width: s.width(),
                    height: s.height(),
                    opacity: 1,
                    zIndex: 15
                }), v = s.width(), g = s.height(), w = 0; u > w; w++)
                for (d = 0; p > d; d++) c = d == p - 1 ? l + 2 : l, a = [f * w + "px", c * (d + 1) + "px", f * (w + 1) + "px", l * d + "px"], r = i.$('<div class="uk-cover-background"></div>').css({
                    position: "absolute",
                    top: 0,
                    left: 0,
                    opacity: 1,
            ...
            return M.last().on(i.support.transition.end, function() {
                setTimeout(x.remove.bind(x), 0), h.resolve()
            }), x.width(), M.css({
